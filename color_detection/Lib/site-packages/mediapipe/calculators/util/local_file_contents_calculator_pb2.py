...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='mediapipe',
  syntax='proto2',
  serialized_pb=_b('\n?mediapipe/calculators/util/local_file_contents_calculator.proto\x12\tmediapipe\x1a$mediapipe/framework/calculator.proto\"\xa0\x01\n\"LocalFileContentsCalculatorOptions\x12\x1c\n\x0eread_as_binary\x18\x01 \x01(\x08:\x04true2\\\n\x03\x65xt\x12\x1c.mediapipe.CalculatorOptions\x18\xbc\x80\xb2\xa5\x01 \x01(\x0b\x32-.mediapipe.LocalFileContentsCalculatorOptions')
  ,
...
_LOCALFILECONTENTSCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='read_as_binary', full_name='mediapipe.LocalFileContentsCalculatorOptions.read_as_binary', index=0,

...
_PACKETRESAMPLERCALCULATOROPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='base_timestamp', full_name='mediapipe.PacketResamplerCalculatorOptions.base_timestamp', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='mediapipe.PacketResamplerCalculatorOptions.start_time', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='mediapipe.PacketResamplerCalculatorOptions.end_time', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='round_limits', full_name='mediapipe.PacketResamplerCalculatorOptions.round_limits', index=8,

...
_TFLITEINFERENCECALCULATOROPTIONS_DELEGATE_GPU = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='use_kernel_caching', full_name='mediapipe.TfLiteInferenceCalculatorOptions.Delegate.Gpu.use_kernel_caching', index=3,
